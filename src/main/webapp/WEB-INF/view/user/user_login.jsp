...
<head>
  ...
  <title>USER LOGIN | PLAYER PORTAL</title>
  ...
  <style>
    :root {
      --bg-dark: #0f172a;
      --user-accent: #f59e0b;
      /* Gradient Cam/Đỏ dành cho Player */
    ...
    body {
      ...
      /* Radial Gradient ánh sáng cam nhẹ */
      background-image:
    ...
    /* Form Styling - Nền đồng bộ, không bị trắng */
    ...
    .form-floating > .form-control:focus {
      background: rgba(15, 23, 42, 0.8); /* Giữ nền kính mờ, không bị trắng */
    ...
    /* Xóa mảng trắng phía sau chữ label của Bootstrap */
...
<div class="login-container">
  <div class="login-card">
    ...
    <h2 class="login-title">Cổng Người Chơi</h2>
    <p class="login-subtitle">Đăng nhập để trải nghiệm thế giới game</p>

    <form action="${pageContext.request.contextPath}/game-management/user/login" method="post">
      ...
      <button class="btn btn-login w-100" type="submit">
        Đăng nhập <i class="bi bi-rocket-takeoff-fill ms-1"></i>
      </button>
    </form>

    <div class="register-link text-center mt-4">
      <span class="text-muted">Bạn chưa có tài khoản? </span>
      <a href="${pageContext.request.contextPath}/game-management/user/register">Tạo tài khoản ngay</a>
    </div>
